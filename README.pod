...
L<version 0.23.0|https://github.com/jgm/cmark/releases/tag/0.23.0>.
It's known to work with 0.21.0, but there's no guarantee that it can be
compiled with versions higher than 0.23.0.
