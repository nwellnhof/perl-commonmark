...
C<sourcepos>, C<hardbreaks>, and C<safe> enable the respective render
options.
...
C<$options> is a bit field created by ORing the following constants:
    ...
    CommonMark::OPT_SOURCEPOS  => 1 << 1
    CommonMark::OPT_HARDBREAKS => 1 << 2
    CommonMark::OPT_SAFE       => 1 << 3
...
This is only supported by some renderers.
...
=head3 Node types
    ...
    CommonMark::NODE_HTML_BLOCK     =>  6
    CommonMark::NODE_CUSTOM_BLOCK   =>  7
    CommonMark::NODE_PARAGRAPH      =>  8
    CommonMark::NODE_HEADING        =>  9
    CommonMark::NODE_THEMATIC_BREAK => 10
    CommonMark::NODE_TEXT           => 11
    CommonMark::NODE_SOFTBREAK      => 12
    CommonMark::NODE_LINEBREAK      => 13
    CommonMark::NODE_CODE           => 14
    CommonMark::NODE_HTML_INLINE    => 15
    CommonMark::NODE_CUSTOM_INLINE  => 16
    CommonMark::NODE_EMPH           => 17
    CommonMark::NODE_STRONG         => 18
    CommonMark::NODE_LINK           => 19
    CommonMark::NODE_IMAGE          => 20
